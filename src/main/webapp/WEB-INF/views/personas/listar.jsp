...
<body>
	<header class="bg-primary">Sistema de gestión de alumnos
		<div style="float:right;">
			<a href="loginServlet?salir=salir" style="color:white;">Salir</a>
		</div>	
	</header>
					...
					<c:forEach var="persona" items="${personas}">
						<tr>
							...
							<td style="max-width:100px;">
								...
								<sf:form modelAttribute="persona"  method="POST" action="personas?detallarPersona"
									 style="display:inline-block;" class="formConsultarPersona">
	    ...
	    <div class="modal-content">
	      <div class="modal-header bg-primary">
			...
			<div class="modal-footer">
				...
				<label for="enviarPersona" class="btn btn-primary">Guardar</label>
			</div>
	    </div>
	  </div>
	</div>
